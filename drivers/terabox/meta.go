...
type Addition struct {
	...
	UserAgent      string `json:"user_agent" required:"true" default:"terabox;1.42.2.150;PC;PC-Windows;10.0.26100;WindowsTeraBox" help:"User agent string for API requests"`
...
var config = driver.Config{
	Name:        "Terabox",
	DefaultRoot: "/",
	// No external dependencies needed since we use retry-go
	//NoOverlayDownload: true,
}
