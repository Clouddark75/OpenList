...
type Addition struct {
	...
	UserAgent      string `json:"user_agent" required:"true" default:"terabox;1.42.6.158;PC;PC-Windows;10.0.26100;WindowsTeraBox" help:"User agent string for API requests"`
