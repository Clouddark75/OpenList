...
type Addition struct {
	...
	UserAgent      string `json:"user_agent" required:"true" default:"terabox;1.40.0.132;PC;PC-Windows;10.0.26100;Windows TeraBox" help:"User agent string for API requests"`
